...
import 'package:rutometro_app/pois/markers_from_assets.dart';
import 'package:rutometro_app/pois/poi_marker_enum.dart';
import 'package:rutometro_app/pois/poi_marker_modal.dart';
...
class POILayer extends MapLayer {
                  ...
                  onTap: () {
                    ...
                    panelCubit.setPanel(
                      MarkerPanel(
                        ...
                        position: TrufiLatLng.fromLatLng(point),
                        minSize: 120,
                      ),
                    );
                  },
  ...
  String name(BuildContext context) {
    final localizationTB = TrufiBaseLocalization.of(context);
